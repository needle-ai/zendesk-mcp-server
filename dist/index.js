...
var ticketsTools = (zendeskClient) => [
  {
    name: "list_tickets",
    ...
    handler: async ({ id, subject, comment, priority, status, assignee_id, group_id, type, tags }) => {
      try {
        ...
        if (assignee_id !== undefined)
          ticketData.assignee_id = assignee_id;
        if (group_id !== undefined)
          ticketData.group_id = group_id;
        if (type !== undefined)
...
// src/tools/ticket-comments.js
var ticketCommentsTools = (zendeskClient) => [
  {
...
var organizationsTools = (zendeskClient) => [
  {
    ...
    handler: async ({ id, name, domain_names, details, notes, tags }) => {
      try {
        ...
        if (domain_names !== undefined)
          orgData.domain_names = domain_names;
        if (details !== undefined)
          orgData.details = details;
        if (notes !== undefined)
          orgData.notes = notes;
        if (tags !== undefined)
          orgData.tags = tags;
...
var triggersTools = (zendeskClient) => [
  {
    name: "list_triggers",
  ...
  },
  {
    ...
    handler: async ({ id, title, description, conditions, actions }) => {
      try {
        const triggerData = {};
        if (title !== undefined)
          triggerData.title = title;
        if (description !== undefined)
          triggerData.description = description;
        if (conditions !== undefined)
          triggerData.conditions = conditions;
        if (actions !== undefined)
          triggerData.actions = actions;
...
var automationsTools = (zendeskClient) => [
  {
  ...
  },
  {
    ...
    handler: async ({ id, title, description, conditions, actions }) => {
      try {
        const automationData = {};
        if (title !== undefined)
          automationData.title = title;
        if (description !== undefined)
          automationData.description = description;
        if (conditions !== undefined)
...
var helpCenterTools = (zendeskClient) => [
  {
    name: "list_articles",
  ...
  },
  {
    ...
    handler: async ({ id, title, body, locale, draft, permission_group_id, user_segment_id, label_names }) => {
      try {
        ...
        if (locale !== undefined)
          articleData.locale = locale;
        if (draft !== undefined)
          articleData.draft = draft;
        if (permission_group_id !== undefined)
          articleData.permission_group_id = permission_group_id;
        if (user_segment_id !== undefined)
          articleData.user_segment_id = user_segment_id;
        if (label_names !== undefined)
          articleData.label_names = label_names;
...
var supportTools = (zendeskClient) => [
  {
    name: "support_info",
...
// src/server.js
var ZendeskMcpServer = (zendeskClient) => {
  ...
  server.resource("documentation", new ResourceTemplate("zendesk://docs/{section}", { list: undefined }), async (uri, { section }) => {
    const docs = {
