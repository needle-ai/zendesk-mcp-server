...
import { ticketCommentsTools } from './tools/ticket-comments.js';
...
export const ZendeskMcpServer = (zendeskClient) => {
  ...
  // Register all tools
  const allTools = [
    ...ticketsTools(zendeskClient),
    ...ticketCommentsTools(zendeskClient),
    ...usersTools(zendeskClient),
    ...organizationsTools(zendeskClient),
    ...groupsTools(zendeskClient),
    ...macrosTools(zendeskClient),
    ...viewsTools(zendeskClient),
    ...triggersTools(zendeskClient),
    ...automationsTools(zendeskClient),
    ...searchTools(zendeskClient),
    ...helpCenterTools(zendeskClient),
    ...supportTools(zendeskClient),
    ...talkTools(zendeskClient),
    ...chatTools(zendeskClient)
  ];
