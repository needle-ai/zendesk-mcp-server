...
export class ZendeskClient {
  constructor(zendeskSubdomain, zendeskEmail, zendeskAccessToken) {
    this.subdomain = zendeskSubdomain;
    this.email = zendeskEmail;
    this.apiToken = zendeskAccessToken;
  }
  ...
  // Ticket Comments
  async listTicketComments(ticket_id) {
    return this.request('GET', `/tickets/${ticket_id}/comments.json`);
  }
  ...
  async getTalkStats() {
    return this.request('GET', '/channels/voice/stats/account_overview.json');
  }

  async listChats(params) {
    return this.request('GET', '/chat/chats.json', null, params);
  }
}
